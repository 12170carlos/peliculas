import "./App.css";
import { useEffect, useState, useRef, useCallback } from "react"; //referencia mutable, que persiste en todo el ciclo de vida del componente
...
function App() {
  ...
  return (
    <div className="page">
      ...
      <main>
        {loading ? <p>Cargando...</p> : <Movies movies={templateMovies} />}
      </main>
    </div>
  );
}
